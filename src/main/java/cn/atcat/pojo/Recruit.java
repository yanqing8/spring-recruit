...
public class Recruit {
    ...
    @NotEmpty
    @Pattern(regexp = "^[\\u4e00-\\u9fa5_a-zA-Z0-9-]{2,20}$",message = "标题格式不正确")
    private String title;// 岗位标题
    @NotEmpty
    @Pattern(regexp = "^[\\u4e00-\\u9fa5_a-zA-Z0-9-]{2,20}$",message = "地址格式不正确")
    private String address;// 岗位地址
    @NotEmpty
    @Pattern(regexp = "^[\\u4e00-\\u9fa5_a-zA-Z0-9-]{2,20}$",message = "薪资格式不正确")
    private String pay;// 岗位大概薪资区间，如10-15k
    @NotEmpty
    @Pattern(regexp = "^[\\u4e00-\\u9fa5_a-zA-Z0-9-]{2,20}$",message = "公司名称格式不正确")
